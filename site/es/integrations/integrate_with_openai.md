...
<h1 id="Semantic-Search-with-Milvus-and-OpenAI" class="common-anchor-header">Semantic Search with Milvus and OpenAI
    <button data-href="#Semantic-Search-with-Milvus-and-OpenAI" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p><a href="https://colab.research.google.com/github/milvus-io/bootcamp/blob/master/bootcamp/tutorials/integration/semantic_search_with_milvus_and_openai.ipynb" target="_parent"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a></p>
...
<pre><code class="language-shell">pip install --upgrade openai pymilvus
...
<h2 id="Searching-book-titles-with-OpenAI--Milvus" class="common-anchor-header">Searching book titles with OpenAI &amp; Milvus
    <button data-href="#Searching-book-titles-with-OpenAI--Milvus" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
