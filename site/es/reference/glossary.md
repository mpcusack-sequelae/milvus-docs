...
<h1 id="Terminology" class="common-anchor-header">Terminology
    <button data-href="#Terminology" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><h2 id="AutoID" class="common-anchor-header">AutoID
    <button data-href="#AutoID" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Auto-Index" class="common-anchor-header">Auto Index
    <button data-href="#Auto-Index" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Attu" class="common-anchor-header">Attu
    <button data-href="#Attu" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Birdwatcher" class="common-anchor-header">Birdwatcher
    <button data-href="#Birdwatcher" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Bulk-Writer" class="common-anchor-header">Bulk Writer
    <button data-href="#Bulk-Writer" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Bulk-Insert" class="common-anchor-header">Bulk Insert
    <button data-href="#Bulk-Insert" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Cardinal" class="common-anchor-header">Cardinal
    <button data-href="#Cardinal" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Channel" class="common-anchor-header">Channel
    <button data-href="#Channel" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Collection" class="common-anchor-header">Collection
    <button data-href="#Collection" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Dependency" class="common-anchor-header">Dependency
    <button data-href="#Dependency" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Dynamic-schema" class="common-anchor-header">Dynamic schema
    <button data-href="#Dynamic-schema" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Embeddings" class="common-anchor-header">Embeddings
    <button data-href="#Embeddings" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Entity" class="common-anchor-header">Entity
    <button data-href="#Entity" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Field" class="common-anchor-header">Field
    <button data-href="#Field" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Filter" class="common-anchor-header">Filter
    <button data-href="#Filter" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Hybrid-search" class="common-anchor-header">Hybrid search
...
<h2 id="Index" class="common-anchor-header">Index
    <button data-href="#Index" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Kafka-Milvus-Connector" class="common-anchor-header">Kafka-Milvus Connector
    <button data-href="#Kafka-Milvus-Connector" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Knowhere" class="common-anchor-header">Knowhere
...
<h2 id="Log-broker" class="common-anchor-header">Log broker
    <button data-href="#Log-broker" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Log-snapshot" class="common-anchor-header">Log snapshot
    <button data-href="#Log-snapshot" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Log-subscriber" class="common-anchor-header">Log subscriber
    <button data-href="#Log-subscriber" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Message-storage" class="common-anchor-header">Message storage
    <button data-href="#Message-storage" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Metric-type" class="common-anchor-header">Metric type
    <button data-href="#Metric-type" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Mmap" class="common-anchor-header">Mmap
    <button data-href="#Mmap" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Milvus-Backup" class="common-anchor-header">Milvus Backup
    <button data-href="#Milvus-Backup" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Milvus-CDC" class="common-anchor-header">Milvus CDC
    <button data-href="#Milvus-CDC" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Milvus-CLI" class="common-anchor-header">Milvus CLI
    <button data-href="#Milvus-CLI" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Milvus-Migration" class="common-anchor-header">Milvus Migration
    <button data-href="#Milvus-Migration" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Milvus-cluster" class="common-anchor-header">Milvus cluster
    <button data-href="#Milvus-cluster" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Multi-Vector" class="common-anchor-header">Multi-Vector
    <button data-href="#Multi-Vector" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Partition" class="common-anchor-header">Partition
    <button data-href="#Partition" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Partition-key" class="common-anchor-header">Partition key
    <button data-href="#Partition-key" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="PChannel" class="common-anchor-header">PChannel
    <button data-href="#PChannel" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="PyMilvus" class="common-anchor-header">PyMilvus
    <button data-href="#PyMilvus" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Schema" class="common-anchor-header">Schema
    <button data-href="#Schema" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Segment" class="common-anchor-header">Segment
    <button data-href="#Segment" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Spark-Milvus-Connector" class="common-anchor-header">Spark-Milvus Connector
    <button data-href="#Spark-Milvus-Connector" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Shard" class="common-anchor-header">Shard
    <button data-href="#Shard" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Sparse-vector" class="common-anchor-header">Sparse vector
    <button data-href="#Sparse-vector" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Unstructured-data" class="common-anchor-header">Unstructured data
    <button data-href="#Unstructured-data" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="VChannel" class="common-anchor-header">VChannel
    <button data-href="#VChannel" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Vector" class="common-anchor-header">Vector
    <button data-href="#Vector" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Zilliz-Cloud" class="common-anchor-header">Zilliz Cloud
    <button data-href="#Zilliz-Cloud" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
