...
<h1 id="Users-and-Roles" class="common-anchor-header">Users and Roles
    <button data-href="#Users-and-Roles" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>
  <span class="img-wrapper">
    <img src="/docs/v2.4.x/assets/users_and_roles.png" alt="users_and_roles" class="doc-image" id="users_and_roles" />
    <span>users_and_roles</span>
  </span>
</p>
<h2 id="Key-concepts" class="common-anchor-header">Key concepts
    <button data-href="#Key-concepts" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<ul>
<li><code>Global</code>: System-wide objects, allowing the user to perform actions that affect all collections, users, or system-wide settings.</li>
<li><code>Collection</code>: Collection-specific objects, allowing the user to perform actions such as creating indexes, loading data, inserting or deleting data, and querying data within a specific collection.</li>
<li><code>User</code>: Objects related to user management, allowing the user to manage credentials and roles for database users, such as updating user credentials or viewing user details.</li>
</ul></li>
<li><p><strong>Object name</strong>: the specific name of the object to control access for. For instance:</p>
<ul>
<li>If the object type is <code>Global</code>, the object name must be set to the wildcard (<code>*</code>), indicating all objects of the specified type.</li>
<li>If the object type is <code>Collection</code>, the object name is the name of a collection.</li>
<li>If the object type is <code>User</code>, the object name is the name of a database user.</li>
</ul></li>
...
<h2 id="Example-Granting-privileges" class="common-anchor-header">Example: Granting privileges
    <button data-href="#Example-Granting-privileges" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>The following code snippet shows how to grant a <code>CreateIndex</code> privilege to a role on a specific collection:</p>
<div class="multipleCode">
    <a href="#python">Python </a>
    <a href="#java">Java</a>
    <a href="#javascript">Node.js</a>
</div>
<pre><code class="language-python">milvusClient.grant_privilege(
...
<pre><code class="language-java"><span class="hljs-type">GrantPrivilegeReq</span> <span class="hljs-variable">grantPrivilegeReq</span> <span class="hljs-operator">=</span> GrantPrivilegeReq.builder()
...
<button class="copy-code-btn"></button></code></pre>
<pre><code class="language-javascript">milvusClient.grantPrivilege({
   roleName: <span class="hljs-string">&#x27;roleName&#x27;</span>,
...
<h2 id="Default-users-and-roles" class="common-anchor-header">Default users and roles
    <button data-href="#Default-users-and-roles" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Milvus creates a <code>root</code> user by default with a default password <code>Milvus</code>. The <code>root</code> user is granted the <code>admin</code> privileges, which means that this <code>root</code> user can have access to all resources and perform all actions.</p>
<p>If a user is associated with the <code>public</code> role, they are entitled to the following privileges:</p>
<ul>
<li><code>DescribeCollection</code></li>
<li><code>ShowCollections</code></li>
<li><code>IndexDetail</code></li>
</ul>
<h2 id="List-of-object-types-and-privileges" class="common-anchor-header">List of object types and privileges
    <button data-href="#List-of-object-types-and-privileges" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
