...
<h1 id="Install-Milvus-Nodejs-SDK" class="common-anchor-header">Install Milvus Nodejs SDK
    <button data-href="#Install-Milvus-Nodejs-SDK" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Compatibility" class="common-anchor-header">Compatibility
    <button data-href="#Compatibility" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Requirement" class="common-anchor-header">Requirement
    <button data-href="#Requirement" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<pre><code class="language-javascript">npm install @zilliz/milvus2-sdk-node
...
<li><p>Explore <a href="/api-reference/node/v{{var.milvus_node_sdk_version}}/About.md">Milvus Node.js API reference</a></p></li>
</ul>
