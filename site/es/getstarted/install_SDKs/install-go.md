...
<h1 id="Install-Milvus-Go-SDK" class="common-anchor-header">Install Milvus Go SDK
    <button data-href="#Install-Milvus-Go-SDK" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Install-Milvus-GO-SDK" class="common-anchor-header">Install Milvus GO SDK
    <button data-href="#Install-Milvus-GO-SDK" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
    ...
    </button></h2><p>Install the Milvus GO SDK and dependencies via <code>go get</code>.</p>
<pre><code class="language-bash">$ <span class="hljs-keyword">go</span> get -u github.com/milvus-io/milvus-sdk-<span class="hljs-keyword">go</span>/v2
