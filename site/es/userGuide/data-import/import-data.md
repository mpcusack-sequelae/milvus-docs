...
<h1 id="Import-data" class="common-anchor-header">Import data
    <button data-href="#Import-data" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>The following code snippet creates a simple collection with the given schema. For more information on parameters, refer to <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Collections/create_schema.md"><code>create_schema()</code></a> and <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Collections/create_collection.md"><code>create_collection()</code></a> in the SDK reference.</p>
</div>
<div class="language-java">
<p>The following code snippet creates a simple collection with the given schema. For more information on parameters, refer to <a href="https://milvus.io/api-reference/java/v2.4.x/v1/Collection/createCollection.md"><code>createCollection()</code></a> in the SDK reference.</p>
</div>
<div class="multipleCode">
  <a href="#python">Python </a>
  <a href="#java">Java</a>
</div>
<pre><code class="language-python">client = MilvusClient(<span class="hljs-string">&quot;http://localhost:19530&quot;</span>)
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="Import-data" class="common-anchor-header">Import data
    <button data-href="#Import-data" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
...
<pre><code><span class="hljs-built_in">export</span> MILVUS_URI=<span class="hljs-string">&quot;localhost:19530&quot;</span>
...
<ul>
<li><p><code>collectionName</code></p>
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="Check-import-progress" class="common-anchor-header">Check import progress
    <button data-href="#Check-import-progress" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="List-Import-Jobs" class="common-anchor-header">List Import Jobs
    <button data-href="#List-Import-Jobs" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
