...
<h1 id="Similarity-Metrics" class="common-anchor-header">Similarity Metrics
    <button data-href="#Similarity-Metrics" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>
  <span class="img-wrapper">
    <img src="/docs/v2.4.x/assets/euclidean_metric.png" alt="euclidean" class="doc-image" id="euclidean" />
    <span>euclidean</span>
  </span>
</p>
...
<p>
  <span class="img-wrapper">
    <img src="/docs/v2.4.x/assets/IP_formula.png" alt="ip" class="doc-image" id="ip" />
    <span>ip</span>
  </span>
</p>
...
<p>
  <span class="img-wrapper">
    <img src="/docs/v2.4.x/assets/normalize_formula.png" alt="normalize" class="doc-image" id="normalize" />
    <span>normalize</span>
  </span>
</p>
...
<p>
  <span class="img-wrapper">
    <img src="/docs/v2.4.x/assets/normalization_formula.png" alt="normalization" class="doc-image" id="normalization" />
...
<p>
  <span class="img-wrapper">
    <img src="/docs/v2.4.x/assets/cosine_similarity.png" alt="cosine_similarity" class="doc-image" id="cosine_similarity" />
...
<p>
  <span class="img-wrapper">
    <img src="/docs/v2.4.x/assets/jaccard_coeff.png" alt="Jaccard similarity coefficient" class="doc-image" id="jaccard-similarity-coefficient" />
...
<p>
  <span class="img-wrapper">
    <img src="/docs/v2.4.x/assets/jaccard_dist.png" alt="Jaccard distance" class="doc-image" id="jaccard-distance" />
...
<p>
  <span class="img-wrapper">
    <img src="/docs/v2.4.x/assets/superstructure.png" alt="superstructure" class="doc-image" id="superstructure" />
...
<p>Once it returns <code>0</code>, <strong>A</strong> is not a superstructure of <strong>B</strong>. Otherwise, the result is the other way around.</p>
<p>To determine whether A is a substructure of B, use the following formula:</p>
<p>
  <span class="img-wrapper">
    <img src="/docs/v2.4.x/assets/substructure.png" alt="substructure" class="doc-image" id="substructure" />
...
<p>Once it returns <code>0</code>, <strong>A</strong> is not a substructure of <strong>B</strong>. Otherwise, the result is the other way around.</p>
