...
<h1 id="Hybrid-Search-with-Milvus" class="common-anchor-header">Hybrid Search with Milvus
    <button data-href="#Hybrid-Search-with-Milvus" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p><a href="https://colab.research.google.com/github/milvus-io/bootcamp/blob/master/bootcamp/tutorials/quickstart/hybrid_search_with_milvus.ipynb" target="_parent"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a></p>
<p><img src="https://raw.githubusercontent.com/milvus-io/bootcamp/master/bootcamp/tutorials/quickstart/apps/hybrid_demo_with_milvus/pics/demo.png"/></p>
...
<h3 id="Dependencies-and-Environment" class="common-anchor-header">Dependencies and Environment</h3><pre><code class="language-shell">$ pip install --upgrade pymilvus <span class="hljs-string">&quot;pymilvus[model]&quot;</span>
...
<pre><code class="language-shell"><span class="hljs-comment"># Run this cell to download the dataset</span>
...
<button class="copy-code-btn"></button></code></pre>
<pre><code>What is the strongest Kevlar cord?
</code></pre>
...
<pre><code class="language-python"><span class="hljs-keyword">from</span> milvus_model.hybrid <span class="hljs-keyword">import</span> BGEM3EmbeddingFunction
...
<button class="copy-code-btn"></button></code></pre>
<pre><code>Fetching 30 files: 100%|██████████| 30/30 [00:00&lt;00:00, 302473.85it/s]
...
<pre><code class="language-python"><span class="hljs-comment"># For efficiency, we insert 50 records in each small batch</span>
...
<button class="copy-code-btn"></button></code></pre>
<pre><code>Number of entities inserted: 502
</code></pre>
<h3 id="Enter-Your-Search-Query" class="common-anchor-header">Enter Your Search Query</h3><pre><code class="language-python"><span class="hljs-comment"># Enter your search query</span>
...
<button class="copy-code-btn"></button></code></pre>
<pre><code>How to start learning programming?
</code></pre>
...
<ul>
<li><code>dense_search</code>: only search across dense vector field</li>
<li><code>sparse_search</code>: only search across sparse vector field</li>
<li><code>hybrid_search</code>: search across both dense and vector fields with a weighted reranker</li>
</ul>
<pre><code class="language-python"><span class="hljs-function"><span class="hljs-keyword">from</span> pymilvus <span class="hljs-title">import</span> (<span class="hljs-params">
    AnnSearchRequest,
    WeightedRanker,
</span>)
...
<pre><code class="language-python">dense_results = <span class="hljs-title function_">dense_search</span>(col, query_embeddings[<span class="hljs-string">&quot;dense&quot;</span>][<span class="hljs-number">0</span>])
...
<pre><code class="language-python"><span class="hljs-keyword">def</span> <span class="hljs-title function_">doc_text_formatting</span>(<span class="hljs-params">ef, query, docs</span>):
...
<pre><code class="language-python"><span class="hljs-keyword">from</span> IPython.display <span class="hljs-keyword">import</span> Markdown, display
