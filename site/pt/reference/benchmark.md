...
<h1 id="Milvus-22-Benchmark-Test-Report" class="common-anchor-header">Milvus 2.2 Benchmark Test Report
    <button data-href="#Milvus-22-Benchmark-Test-Report" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Terminology" class="common-anchor-header">Terminology
...
<h2 id="Test-environment" class="common-anchor-header">Test environment
    <button data-href="#Test-environment" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Test-pipeline" class="common-anchor-header">Test pipeline
    <button data-href="#Test-pipeline" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li>Insert 1 million SIFT vectors. Build an HNSW index and configure the index parameters by setting <code>M</code> to <code>8</code> and <code>efConstruction</code> to <code>200</code>.</li>
<li>Load the collection.</li>
<li>Search with different concurrent numbers with search parameters <code>nq=1, topk=1, ef=64</code>, the duration of each concurrency is at least 1 hour.</li>
</ol>
<h2 id="Test-results" class="common-anchor-header">Test results
    <button data-href="#Test-results" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<pre><code class="language-yaml"><span class="hljs-attr">queryNode</span>:
...
<p>
  <span class="img-wrapper">
    <img src="/docs/v2.4.x/assets/cluster_search_performance_210_vs_220.png" alt="Cluster search performance" class="doc-image" id="cluster-search-performance" />
...
<pre><code class="language-yaml"><span class="hljs-attr">standalone</span>:
  <span class="hljs-attr">replicas</span>: <span class="hljs-number">1</span>
  <span class="hljs-attr">resources</span>:
    <span class="hljs-attr">limits</span>:
      <span class="hljs-attr">cpu</span>: <span class="hljs-string">&quot;12.0&quot;</span>
...
<p>
  <span class="img-wrapper">
    <img src="/docs/v2.4.x/assets/standalone_search_performance_210_vs_220.png" alt="Standalone search performance" class="doc-image" id="standalone-search-performance" />
...
<p>
  <span class="img-wrapper">
    <img src="/docs/v2.4.x/assets/search_performance_by_querynode_cpu_cores.png" alt="Search performance by Querynode CPU cores" class="doc-image" id="search-performance-by-querynode-cpu-cores" />
...
<div class="alert note">
<p>Note: the number of Querynodes equals the <code>replica_number</code> when loading the collection.</p>
</div>
<p><details>
<summary><b>Server configurations (cluster)</b></summary></p>
<pre><code class="language-yaml"><span class="hljs-attr">queryNode</span>:
...
<p>
  <span class="img-wrapper">
    <img src="/docs/v2.4.x/assets/search_performance_by_querynode_replicas.png" alt="Search performance by Querynode replicas" class="doc-image" id="search-performance-by-querynode-replicas" />
