...
<h1 id="Install-Milvus-Java-SDK" class="common-anchor-header">Install Milvus Java SDK
    <button data-href="#Install-Milvus-Java-SDK" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Install-Milvus-Java-SDK" class="common-anchor-header">Install Milvus Java SDK
    <button data-href="#Install-Milvus-Java-SDK" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
...
<pre><code>implementation <span class="hljs-string">&#x27;io.milvus:milvus-sdk-java:{{var.milvus_java_sdk_real_version}}&#x27;</span>
<button class="copy-code-btn"></button></code></pre>
...
<li><p>Explore <a href="/api-reference/java/v{{var.milvus_java_sdk_version}}/About.md">Milvus Java API reference</a></p></li>
</ul>
