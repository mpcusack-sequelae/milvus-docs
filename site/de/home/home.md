...
<h2 id="Get-Started" class="common-anchor-header">Get Started
    <button data-href="#Get-Started" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<div class="start_card_container">
  <a href="/docs/install_standalone-docker.md">
    <img  src="/docs/v2.4.x/assets/home_install.svg" alt="icon" />
...
<div class="start_card_container">
  <a href="/docs/quickstart.md">
    <img  src="/docs/v2.4.x/assets/home_quick_start.svg" alt="icon" />
...
<div class="start_card_container">
  <a href="/bootcamp">
    <img  src="/docs/v2.4.x/assets/home_bootcamp.svg" alt="icon" />
...
<h2 id="Recommended-articles" class="common-anchor-header">Recommended articles
    <button data-href="#Recommended-articles" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Whats-new-in-docs" class="common-anchor-header">What’s new in docs
    <button data-href="#Whats-new-in-docs" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
