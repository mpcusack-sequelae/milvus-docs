...
<h1 id="Local-Storage-related-Configurations" class="common-anchor-header">Local Storage-related Configurations
    <button data-href="#Local-Storage-related-Configurations" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="localStoragepath" class="common-anchor-header"><code>localStorage.path</code>
    <button data-href="#localStoragepath" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="localStorageenabled" class="common-anchor-header"><code>localStorage.enabled</code>
    <button data-href="#localStorageenabled" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
