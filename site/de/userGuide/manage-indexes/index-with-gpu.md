...
<h1 id="Index-with-GPU" class="common-anchor-header">Index with GPU
    <button data-href="#Index-with-GPU" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Configure-Milvus-settings-for-GPU-memory-control" class="common-anchor-header">Configure Milvus settings for GPU memory control
    <button data-href="#Configure-Milvus-settings-for-GPU-memory-control" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>It supports two parameters <code>initMemSize</code> and <code>maxMemSize</code> in <a href="https://github.com/milvus-io/milvus/blob/master/configs/milvus.yaml#L767-L769">Milvus config file</a>. The pool size is initially set to <code>initMemSize</code>, and will be automatically expanded to <code>maxMemSize</code> after exceeding this limit.</p>
<p>The default <code>initMemSize</code> is 1/2 of the available GPU memory when Milvus starts, and the default <code>maxMemSize</code> is equal to all available GPU memory.</p>
...
<pre><code class="language-yaml">gpu:
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="Build-an-index" class="common-anchor-header">Build an index
    <button data-href="#Build-an-index" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<pre><code class="language-python">index_params = {
...
<h3 id="Build-index" class="common-anchor-header">Build index</h3><p>After configuring the index parameters in <strong>index_params</strong>, call the <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/ORM/Collection/create_index.md"><code>create_index()</code></a> method to build the index.</p>
<pre><code class="language-python"><span class="hljs-comment"># Get an existing collection</span>
...
<ul>
<li><p><strong>GPU_BRUTE_FORCE</strong> index</p>
<pre><code class="language-python">search_params = {
    <span class="hljs-string">&quot;metric_type&quot;</span>: <span class="hljs-string">&quot;L2&quot;</span>,
    <span class="hljs-string">&quot;params&quot;</span>: {}
}
<button class="copy-code-btn"></button></code></pre>
...
<h3 id="Conduct-a-search" class="common-anchor-header">Conduct a search</h3><p>Use the <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/ORM/Collection/search.md"><code>search()</code></a> method to perform a vector similarity search on the GPU index.</p>
<pre><code class="language-python"><span class="hljs-comment"># Load data into memory</span>
collection.load()
