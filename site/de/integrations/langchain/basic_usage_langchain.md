...
<h1 id="Use-Milvus-as-a-Vector-Store" class="common-anchor-header">Use Milvus as a Vector Store
    <button data-href="#Use-Milvus-as-a-Vector-Store" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Setup" class="common-anchor-header">Setup
    ...
    </button></h2><p>You’ll need to install <code>langchain-milvus</code> with <code>pip install -qU langchain-milvus</code> to use this integration.</p>
<pre><code class="language-python">%pip install -qU  langchain_milvus
...
<h3 id="Credentials" class="common-anchor-header">Credentials</h3><p>No credentials are needed to use the <code>Milvus</code> vector store.</p>
<h2 id="Initialization" class="common-anchor-header">Initialization
    <button data-href="#Initialization" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><pre><code class="language-{=mdx}"><span class="hljs-keyword">import</span> <span class="hljs-title class_">EmbeddingTabs</span> <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;@theme/EmbeddingTabs&quot;</span>;

&lt;EmbeddingTabs/&gt;
<button class="copy-code-btn"></button></code></pre>
<pre><code class="language-python"><span class="hljs-comment"># | output: false</span>
...
<button class="copy-code-btn"></button></code></pre>
<pre><code class="language-python"><span class="hljs-keyword">from</span> langchain_milvus <span class="hljs-keyword">import</span> Milvus
...
<pre><code class="language-python"><span class="hljs-keyword">from</span> langchain_core.<span class="hljs-property">documents</span> <span class="hljs-keyword">import</span> <span class="hljs-title class_">Document</span>
...
<pre><code class="language-python">vector_store_loaded = <span class="hljs-title class_">Milvus</span>(
    embeddings,
    connection_args={<span class="hljs-string">&quot;uri&quot;</span>: <span class="hljs-variable constant_">URI</span>},
    collection_name=<span class="hljs-string">&quot;langchain_example&quot;</span>,
)
<button class="copy-code-btn"></button></code></pre>
<h2 id="Manage-vector-store" class="common-anchor-header">Manage vector store
    <button data-href="#Manage-vector-store" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Add-items-to-vector-store" class="common-anchor-header">Add items to vector store</h3><p>We can add items to our vector store by using the <code>add_documents</code> function.</p>
<pre><code class="language-python"><span class="hljs-keyword">from</span> uuid <span class="hljs-keyword">import</span> uuid4
...
<button class="copy-code-btn"></button></code></pre>
<pre><code>['b0248595-2a41-4f6b-9c25-3a24c1278bb3',
...
<h3 id="Delete-items-from-vector-store" class="common-anchor-header">Delete items from vector store</h3><pre><code class="language-python">vector_store.<span class="hljs-built_in">delete</span>(ids=[uuids[<span class="hljs-number">-1</span>]])
<button class="copy-code-btn"></button></code></pre>
<pre><code>(insert count: 0, delete count: 1, upsert count: 0, timestamp: 0, success count: 0, err count: 0, cost: 0)
</code></pre>
<h2 id="Query-vector-store" class="common-anchor-header">Query vector store
    <button data-href="#Query-vector-store" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<pre><code class="language-python">results = vector_store.similarity_search(
...
<button class="copy-code-btn"></button></code></pre>
<pre><code>* Building an exciting new project with LangChain - come check it out! [{'pk': '9905001c-a4a3-455e-ab94-72d0ed11b476', 'source': 'tweet'}]
...
<pre><code class="language-python">results = vector_store.similarity_search_with_score(
...
<button class="copy-code-btn"></button></code></pre>
<pre><code>* [SIM=21192.628906] bar [{'pk': '2', 'source': 'https://example.com'}]
</code></pre>
<p>For a full list of all the search options available when using the <code>Milvus</code> vector store, you can visit the <a href="https://api.python.langchain.com/en/latest/vectorstores/langchain_milvus.vectorstores.milvus.Milvus.html">API reference</a>.</p>
...
<pre><code class="language-python">retriever = vector_store.as_retriever(search_type=<span class="hljs-string">&quot;mmr&quot;</span>, search_kwargs={<span class="hljs-string">&quot;k&quot;</span>: <span class="hljs-number">1</span>})
...
<button class="copy-code-btn"></button></code></pre>
<pre><code>[Document(metadata={'pk': 'eacc7256-d7fa-4036-b1f7-83d7a4bee0c5', 'source': 'news'}, page_content='Robbers broke into the city bank and stole $1 million in cash.')]
</code></pre>
<h2 id="Usage-for-retrieval-augmented-generation" class="common-anchor-header">Usage for retrieval-augmented generation
    <button data-href="#Usage-for-retrieval-augmented-generation" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<pre><code class="language-python"><span class="hljs-keyword">from</span> langchain_core.documents <span class="hljs-keyword">import</span> Document
...
<p><code>search_kwargs={&quot;expr&quot;: '&lt;partition_key&gt; == &quot;xxxx&quot;'}</code></p>
<p><code>search_kwargs={&quot;expr&quot;: '&lt;partition_key&gt; == in [&quot;xxx&quot;, &quot;xxx&quot;]'}</code></p>
...
<pre><code class="language-python"><span class="hljs-comment"># This will only get documents for Ankush</span>
...
<button class="copy-code-btn"></button></code></pre>
<pre><code>[Document(page_content='i worked at facebook', metadata={'namespace': 'ankush'})]
</code></pre>
<pre><code class="language-python"><span class="hljs-comment"># This will only get documents for Harrison</span>
...
<button class="copy-code-btn"></button></code></pre>
<pre><code>[Document(page_content='i worked at kensho', metadata={'namespace': 'harrison'})]
</code></pre>
