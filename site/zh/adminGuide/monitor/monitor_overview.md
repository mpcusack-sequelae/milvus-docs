...
<h1 id="Milvus-monitoring-framework-overview" class="common-anchor-header">Milvus monitoring framework overview
    <button data-href="#Milvus-monitoring-framework-overview" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Prometheus-in-Milvus" class="common-anchor-header">Prometheus in Milvus
    <button data-href="#Prometheus-in-Milvus" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>For instance, the Milvus metric that calculates the total number of vectors queried is named <code>milvus_proxy_search_vectors_count</code>.</p>
...
<h2 id="Grafana-in-Milvus" class="common-anchor-header">Grafana in Milvus
    <button data-href="#Grafana-in-Milvus" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
