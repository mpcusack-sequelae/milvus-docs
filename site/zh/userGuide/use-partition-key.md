...
<h1 id="Use-Partition-Key" class="common-anchor-header">Use Partition Key
    <button data-href="#Use-Partition-Key" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Enable-partition-key" class="common-anchor-header">Enable partition key
    <button data-href="#Enable-partition-key" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>To set a field as the partition key, specify <code>partition_key_field</code> when creating a collection schema.</p>
<p>In the example code below, <code>num_partitions</code> determines the number of partitions that will be created. By default, it is set to <code>16</code>. We recommend you retain the default value.</p>
...
<p>For more information on parameters, refer to <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Client/MilvusClientV2.md"><code>MilvusClientV2</code></a>, <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Collections/createSchema.md"><code>createSchema()</code></a>, and <a href="https://milvus.io/api-reference/java/v2.4.x/v2/CollectionSchema/addField.md"><code>addField()</code></a> in the SDK reference.</p>
</div>
<div class="language-javascript">
<p>For more information on parameters, refer to <a href="https://milvus.io/api-reference/node/v2.4.x/Client/MilvusClient.md"><code>MilvusClient</code></a> and <a href="https://milvus.io/api-reference/node/v2.4.x/Collections/createCollection.md"><code>createCollection()</code></a> in the SDK reference.</p>
</div>
...
<pre><code class="language-python">index_params = MilvusClient.prepare_index_params()
...
<button class="copy-code-btn"></button></code></pre>
<pre><code class="language-java"><span class="hljs-comment">// 2.3 Prepare index parameters</span>
...
<button class="copy-code-btn"></button></code></pre>
<pre><code class="language-javascript"><span class="hljs-comment">// 2.2 Prepare index parameters</span>
...
<pre><code class="language-python">client.<span class="hljs-title function_">create_collection</span>(
    collection_name=<span class="hljs-string">&quot;test_collection&quot;</span>,
    schema=schema,
    index_params=index_params
)
<button class="copy-code-btn"></button></code></pre>
<pre><code class="language-java"><span class="hljs-comment">// 2.4 Create a collection with schema and index parameters</span>
...
<button class="copy-code-btn"></button></code></pre>
<pre><code class="language-javascript"><span class="hljs-comment">// 2.3 Create a collection with fields and index parameters</span>
...
<button class="copy-code-btn"></button></code></pre>
<pre><code class="language-java"><span class="hljs-comment">// 3. Insert randomly generated vectors</span>
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<h2 id="Use-partition-key" class="common-anchor-header">Use partition key
    <button data-href="#Use-partition-key" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
...
<pre><code class="language-python"><span class="hljs-comment"># 4. Search with partition key</span>
...
<span class="hljs-comment"># ]</span>
<button class="copy-code-btn"></button></code></pre>
<pre><code class="language-java"><span class="hljs-comment">// 4. Search with partition key</span>
...
<span class="hljs-comment">// ]]}</span>
<button class="copy-code-btn"></button></code></pre>
<pre><code class="language-javascript"><span class="hljs-comment">// 4. Search with partition key</span>
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<h2 id="Typical-use-cases" class="common-anchor-header">Typical use cases
    <button data-href="#Typical-use-cases" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
