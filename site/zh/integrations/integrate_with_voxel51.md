...
<h1 id="Conduct-Vision-Searches-with-Milvus-and-FiftyOne" class="common-anchor-header">Conduct Vision Searches with Milvus and FiftyOne
    <button data-href="#Conduct-Vision-Searches-with-Milvus-and-FiftyOne" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li>A Python environment with <code>pymilvus</code> and <code>fiftyone</code> installed.</li>
...
<h2 id="Installing-Requirements" class="common-anchor-header">Installing Requirements
    ...
    </button></h2><p>For this example, we are going to use <code>pymilvus</code> and <code>fiftyone</code>. You can install them by running the following commands:</p>
<pre><code class="language-shell">python3 -m pip install pymilvus fiftyone torch torchvision
<button class="copy-code-btn"></button></code></pre>
<h2 id="Basic-recipe" class="common-anchor-header">Basic recipe
    <button data-href="#Basic-recipe" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li>Use the <a href="https://docs.voxel51.com/api/fiftyone.brain.html#fiftyone.brain.compute_similarity"><code>compute_similarity()</code></a> method to generate a Milvus similarity index for the samples or object patches in a dataset by setting the parameter <code>backend=&quot;milvus&quot;</code> and specifying a <code>brain_key</code> of your choice.</li>
<li>Use this Milvus similarity index to query your data with <a href="https://docs.voxel51.com/api/fiftyone.core.collections.html#fiftyone.core.collections.SampleCollection.sort_by_similarity"><code>sort_by_similarity()</code></a>.</li>
<li>If desired, delete the index.</li>
</ol>
<h2 id="Procedures" class="common-anchor-header">Procedures
    <button data-href="#Procedures" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<pre><code class="language-python"><span class="hljs-keyword">import</span> fiftyone <span class="hljs-keyword">as</span> fo
...
<pre><code class="language-python"><span class="hljs-comment"># Step 4: Query your data</span>
...
<pre><code class="language-python"><span class="hljs-comment"># Step 5: Delete the index</span>
milvus_index.delete()
<button class="copy-code-btn"></button></code></pre>
<h2 id="Use-the-Milvus-backend" class="common-anchor-header">Use the Milvus backend
    <button data-href="#Use-the-Milvus-backend" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>By default, calling <a href="https://docs.voxel51.com/api/fiftyone.brain.html#fiftyone.brain.compute_similarity"><code>compute_similarity()</code></a> or <code>sort_by_similarity()</code> will use a sklearn backend.</p>
<p>To use the Milvus backend, simply set the optional backend parameter of <a href="https://docs.voxel51.com/api/fiftyone.brain.html#fiftyone.brain.compute_similarity"><code>compute_similarity()</code></a> to <code>&quot;milvus&quot;</code>:</p>
<pre><code class="language-python"><span class="hljs-keyword">import</span> fiftyone.<span class="hljs-property">brain</span> <span class="hljs-keyword">as</span> fob
...
<pre><code class="language-shell"><span class="hljs-keyword">export</span> <span class="hljs-variable constant_">FIFTYONE_BRAIN_DEFAULT_SIMILARITY_BACKEND</span>=milvus
<button class="copy-code-btn"></button></code></pre>
<p>or by setting the <code>default_similarity_backend</code> parameter of your <a href="https://docs.voxel51.com/user_guide/brain.html#brain-config">brain config</a> located at <code>~/.fiftyone/brain_config.json</code>:</p>
<pre><code class="language-json">{
    <span class="hljs-string">&quot;default_similarity_backend&quot;</span>: <span class="hljs-string">&quot;milvus&quot;</span>
}
<button class="copy-code-btn"></button></code></pre>
<h2 id="Authentication" class="common-anchor-header">Authentication
    <button data-href="#Authentication" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<pre><code class="language-python"><span class="hljs-built_in">export</span> FIFTYONE_BRAIN_SIMILARITY_MILVUS_URI=XXXXXX
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="FiftyOne-Brain-config" class="common-anchor-header">FiftyOne Brain config</h3><p>You can also store your credentials in your <a href="https://docs.voxel51.com/user_guide/brain.html#brain-config">brain config</a> located at <code>~/.fiftyone/brain_config.json</code>:</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Note that, when using this strategy, you must manually provide the credentials when loading an index later via <a href="https://docs.voxel51.com/api/fiftyone.core.collections.html#fiftyone.core.collections.SampleCollection.load_brain_results"><code>load_brain_results()</code></a>:</p>
<pre><code class="language-python">milvus_index = dataset.load_brain_results(
...
<li><p><strong>metric</strong> (<em>“dotproduct”</em>): the embedding distance metric to use when creating a new index. The supported values are (<code>&quot;dotproduct&quot;</code>, <code>&quot;euclidean&quot;</code>)</p></li>
<li><p><strong>consistency_level</strong> (<em>“Session”</em>): the consistency level to use. Supported values are (<code>&quot;Strong&quot;</code>, <code>&quot;Session&quot;</code>, <code>&quot;Bounded&quot;</code>, <code>&quot;Eventually&quot;</code>)</p></li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<p>However, typically these parameters are directly passed to <a href="https://docs.voxel51.com/api/fiftyone.brain.html#fiftyone.brain.compute_similarity"><code>compute_similarity()</code></a> to configure a specific new index:</p>
<pre><code class="language-python">milvus_index = fob.<span class="hljs-title function_">compute_similarity</span>(
    ...
    backend=<span class="hljs-string">&quot;milvus&quot;</span>,
    brain_key=<span class="hljs-string">&quot;milvus_index&quot;</span>,
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="Manage-brain-runs" class="common-anchor-header">Manage brain runs
    <button data-href="#Manage-brain-runs" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>For example, you can call <a href="https://docs.voxel51.com/api/fiftyone.core.collections.html#fiftyone.core.collections.SampleCollection.list_brain_runs"><code>list_brain_runs()</code></a> to see the available brain keys on a dataset:</p>
<pre><code class="language-python"><span class="hljs-keyword">import</span> fiftyone.brain <span class="hljs-keyword">as</span> fob
...
<button class="copy-code-btn"></button></code></pre>
<p>Or, you can use <a href="https://docs.voxel51.com/api/fiftyone.core.collections.html#fiftyone.core.collections.SampleCollection.get_brain_info"><code>get_brain_info()</code></a> to retrieve information about the configuration of a brain run:</p>
<pre><code class="language-python">info = dataset.get_brain_info(brain_key)
<span class="hljs-built_in">print</span>(info)
<button class="copy-code-btn"></button></code></pre>
<p>Use <a href="https://docs.voxel51.com/api/fiftyone.core.collections.html#fiftyone.core.collections.SampleCollection.load_brain_results"><code>load_brain_results()</code></a> to load the <a href="https://docs.voxel51.com/api/fiftyone.brain.similarity.html#fiftyone.brain.similarity.SimilarityIndex"><code>SimilarityIndex</code></a> instance for a brain run.</p>
<p>You can use <a href="https://docs.voxel51.com/api/fiftyone.core.collections.html#fiftyone.core.collections.SampleCollection.rename_brain_run"><code>rename_brain_run()</code></a> to rename the brain key associated with an existing similarity results run:</p>
<pre><code class="language-python">dataset.rename_brain_run(brain_key, new_brain_key)
<button class="copy-code-btn"></button></code></pre>
<p>Finally, you can use <a href="https://docs.voxel51.com/api/fiftyone.core.collections.html#fiftyone.core.collections.SampleCollection.delete_brain_run"><code>delete_brain_run()</code></a> to delete a brain run:</p>
<pre><code class="language-python">dataset.delete_brain_run(brain_key)
<button class="copy-code-btn"></button></code></pre>
<div class="alert note">
<p>Calling <a href="https://docs.voxel51.com/api/fiftyone.core.collections.html#fiftyone.core.collections.SampleCollection.delete_brain_run"><code>delete_brain_run()</code></a> only deletes the record of the brain run from your FiftyOne dataset; it will not delete any associated Milvus collection, which you can do as follows:</p>
<pre><code class="language-python"><span class="hljs-comment"># Delete the Milvus collection</span>
