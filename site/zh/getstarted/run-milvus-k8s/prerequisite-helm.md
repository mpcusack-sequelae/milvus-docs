...
<h1 id="Requirements-for-running-Milvus-on-Kubernetes" class="common-anchor-header">Requirements for running Milvus on Kubernetes
    <button data-href="#Requirements-for-running-Milvus-on-Kubernetes" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Hardware-requirements" class="common-anchor-header">Hardware requirements
    <button data-href="#Hardware-requirements" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<pre><code class="language-bash"><span class="hljs-built_in">mkdir</span> test-data
