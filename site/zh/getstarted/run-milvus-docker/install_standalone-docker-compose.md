...
<h1 id="Run-Milvus-with-Docker-Compose" class="common-anchor-header">Run Milvus with Docker Compose
    <button data-href="#Run-Milvus-with-Docker-Compose" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<pre><code class="language-shell"><span class="hljs-comment"># Download the configuration file</span>
