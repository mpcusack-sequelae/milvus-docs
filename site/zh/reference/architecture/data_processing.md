...
<h1 id="Data-Processing" class="common-anchor-header">Data Processing
    <button data-href="#Data-Processing" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Data-insertion" class="common-anchor-header">Data insertion
    <button data-href="#Data-insertion" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>
  <span class="img-wrapper">
    <img src="/docs/v2.4.x/assets/channels_1.jpg" alt="Channels 1" class="doc-image" id="channels-1" />
...
<p>
  <span class="img-wrapper">
    <img src="/docs/v2.4.x/assets/channels_2.jpg" alt="Channels 2" class="doc-image" id="channels-2" />
...
<p>
  <span class="img-wrapper">
    <img src="/docs/v2.4.x/assets/write_log_sequence.jpg" alt="Write log sequence" class="doc-image" id="write-log-sequence" />
...
<h2 id="Index-building" class="common-anchor-header">Index building
    <button data-href="#Index-building" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>
  <span class="img-wrapper">
    <img src="/docs/v2.4.x/assets/index_building.jpg" alt="Index building" class="doc-image" id="index-building" />
...
<h2 id="Data-query" class="common-anchor-header">Data query
    <button data-href="#Data-query" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>
  <span class="img-wrapper">
    <img src="/docs/v2.4.x/assets/data_query.jpg" alt="Data query" class="doc-image" id="data-query" />
...
<p>
  <span class="img-wrapper">
    <img src="/docs/v2.4.x/assets/handoff.jpg" alt="Handoff" class="doc-image" id="handoff" />
    <span>Handoff</span>
  </span>
</p>
