...
<h1 id="etcd-related-Configurations" class="common-anchor-header">etcd-related Configurations
    <button data-href="#etcd-related-Configurations" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
To share an etcd instance among multiple Milvus instances, you need to change <code>etcd.rootPath</code> to a unique value for each of the Milvus instances. For details, refer to <a href="/docs/operational_faq.md#Can-I-share-an-etcd-instance-among-multiple-Milvus-instances">Operation FAQs</a>.
</div>
<h2 id="etcdendpoints" class="common-anchor-header"><code>etcd.endpoints</code>
    <button data-href="#etcdendpoints" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="etcdrootPath" class="common-anchor-header"><code>etcd.rootPath</code>
    <button data-href="#etcdrootPath" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="etcdmetaSubPath" class="common-anchor-header"><code>etcd.metaSubPath</code>
    <button data-href="#etcdmetaSubPath" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="etcdkvSubPath" class="common-anchor-header"><code>etcd.kvSubPath</code>
    <button data-href="#etcdkvSubPath" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
