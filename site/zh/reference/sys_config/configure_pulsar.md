...
<h1 id="Pulsar-related-Configurations" class="common-anchor-header">Pulsar-related Configurations
    <button data-href="#Pulsar-related-Configurations" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="pulsaraddress" class="common-anchor-header"><code>pulsar.address</code>
    <button data-href="#pulsaraddress" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="pulsarport" class="common-anchor-header"><code>pulsar.port</code>
    <button data-href="#pulsarport" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="pulsarwebport" class="common-anchor-header"><code>pulsar.webport</code>
    <button data-href="#pulsarwebport" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="pulsarmaxMessageSize" class="common-anchor-header"><code>pulsar.maxMessageSize</code>
    <button data-href="#pulsarmaxMessageSize" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="pulsartenant" class="common-anchor-header"><code>pulsar.tenant</code>
    <button data-href="#pulsartenant" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
  ...
  <tbody>
    <tr>
      <td>
        ...
        <li>To share a Pulsar instance among multiple Milvus instances, you can change this to an Pulsar tenant rather than the default one for each Milvus instance before you start them. However, if you do not want Pulsar multi-tenancy, you are advised to change <code>msgChannel.chanNamePrefix.cluster</code> to the different value. For details, see <a href="/docs/operational_faq.md#Can-I-share-a-Pulsar-instance-among-multiple-Milvus-instances">Operation FAQs</a>.</li>
      </td>
      <td>public</td>
    </tr>
  </tbody>
</table>
<h2 id="pulsarnamespace" class="common-anchor-header"><code>pulsar.namespace</code>
    <button data-href="#pulsarnamespace" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
