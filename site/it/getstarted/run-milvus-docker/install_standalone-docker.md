...
<h1 id="Run-Milvus-in-Docker" class="common-anchor-header">Run Milvus in Docker
    <button data-href="#Run-Milvus-in-Docker" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Install-Milvus-in-Docker" class="common-anchor-header">Install Milvus in Docker
    <button data-href="#Install-Milvus-in-Docker" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<pre><code class="language-shell"><span class="hljs-comment"># Download the installation script</span>
