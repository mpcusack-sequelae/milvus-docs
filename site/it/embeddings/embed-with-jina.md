...
<h1 id="Jina-AI" class="common-anchor-header">Jina AI
    <button data-href="#Jina-AI" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>Then, instantiate the <code>JinaEmbeddingFunction</code>:</p>
...
<p>The name of the Jina AI embedding model to use for encoding. You can specify any of the available Jina AI embedding model names, for example, <code>jina-embeddings-v2-base-en</code>, <code>jina-embeddings-v2-small-en</code>, etc. If you leave this parameter unspecified, <code>jina-embeddings-v2-base-en</code> will be used. For a list of available models, refer to <a href="https://jina.ai/embeddings">Jina Embeddings</a>.</p></li>
...
<pre><code class="language-python">Embeddings: [array([-4.88487840e-01, -4.28095880e-01,  4.90086500e-01, -1.63274320e-01,
...
<button class="copy-code-btn"></button></code></pre>
<p>The expected output is similar to the following:</p>
<pre><code class="language-python">Embeddings: [array([-5.99164660e-01, -3.49827350e-01,  8.22405160e-01, -1.18632730e-01,
