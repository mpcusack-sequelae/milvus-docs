...
<h1 id="Release-Notes" class="common-anchor-header">Release Notes
    <button data-href="#Release-Notes" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="v248" class="common-anchor-header">v2.4.8
    <button data-href="#v248" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li>Utilized the new <code>range_search_k</code> parameter in Knowhere to speed up range searches. (<a href="https://github.com/milvus-io/milvus/pull/34709">#34709</a>)</li>
...
<li>Pre-allocated <code>FieldData</code> for Reduce operations. (<a href="https://github.com/milvus-io/milvus/pull/34254">#34254</a>)</li>
...
<li><p>For open-source users, this version changes the metric types in AutoIndex for <code>FloatVector</code> and <code>BinaryVector</code> to <code>Cosine</code> and <code>Hamming</code>, respectively.</p></li>
...
<li>Developers using Ubuntu 22.04 will benefit immediately from these changes. However, developers on other operating systems may need to upgrade their <code>glibc</code> version to avoid compatibility issues.</li>
</ul></li>
</ul>
...
<li>Resolved a SIGBUS exception that occurred due to incorrect usage of <code>mmap</code>. [<a href="https://github.com/milvus-io/milvus/pull/34455">#34455</a>, <a href="https://github.com/milvus-io/milvus/pull/34530">#34530</a>]</li>
...
<li>Ensured <code>compressBinlog</code> is executed to allow <code>reloadFromKV</code> to properly fill binlog’s <code>logID</code> after DataCoord restarts. (<a href="https://github.com/milvus-io/milvus/pull/34062">#34062</a>)</li>
...
<li>Captured <code>ErrKeyNotFound</code> during CAS (Compare and Swap) operations in the configuration. (<a href="https://github.com/milvus-io/milvus/pull/34489">#34489</a>)</li>
...
<h2 id="v246" class="common-anchor-header">v2.4.6
    <button data-href="#v246" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li>Passed the <code>otlpSecure</code> config when setting up segcore tracing (<a href="https://github.com/milvus-io/milvus/pull/34210">#34210</a>).</li>
...
<h2 id="v245" class="common-anchor-header">v2.4.5
    <button data-href="#v245" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="v244" class="common-anchor-header">v2.4.4
    <button data-href="#v244" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="v243" class="common-anchor-header">v2.4.3
    <button data-href="#v243" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="v241" class="common-anchor-header">v2.4.1
    <button data-href="#v241" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="v240" class="common-anchor-header">v2.4.0
    <button data-href="#v240" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="v240-rc1" class="common-anchor-header">v2.4.0-rc.1
    <button data-href="#v240-rc1" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
