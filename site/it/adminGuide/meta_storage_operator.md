...
<h1 id="Configure-Meta-Storage-with-Milvus-Operator" class="common-anchor-header">Configure Meta Storage with Milvus Operator
    <button data-href="#Configure-Meta-Storage-with-Milvus-Operator" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Configure-etcd" class="common-anchor-header">Configure etcd
    ...
    </button></h2><p>Add required fields under <code>spec.dependencies.etcd</code> to configure etcd.</p>
