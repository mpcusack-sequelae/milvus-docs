...
<h1 id="Semantic-Search-with-Milvus-and-VoyageAI" class="common-anchor-header">Semantic Search with Milvus and VoyageAI
    <button data-href="#Semantic-Search-with-Milvus-and-VoyageAI" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p><a href="https://colab.research.google.com/github/milvus-io/bootcamp/blob/master/bootcamp/tutorials/integration/semantic_search_with_milvus_and_voyageai.ipynb" target="_parent"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a></p>
...
<pre><code class="language-python">$ pip install --upgrade voyageai pymilvus
...
<h2 id="Searching-book-titles-with-VoyageAI--Milvus" class="common-anchor-header">Searching book titles with VoyageAI &amp; Milvus
    <button data-href="#Searching-book-titles-with-VoyageAI--Milvus" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<pre><code class="language-python"><span class="hljs-keyword">import</span> voyageai
...
<button class="copy-code-btn"></button></code></pre>
<pre><code>Query: When was artificial intelligence founded?
