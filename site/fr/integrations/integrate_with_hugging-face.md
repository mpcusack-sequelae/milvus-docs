...
<h1 id="Question-Answering-Using-Milvus-and-Hugging-Face" class="common-anchor-header">Question Answering Using Milvus and Hugging Face
    <button data-href="#Question-Answering-Using-Milvus-and-Hugging-Face" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p><a href="https://colab.research.google.com/github/milvus-io/bootcamp/blob/master/bootcamp/tutorials/integration/qa_with_milvus_and_hf.ipynb" target="_parent"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a></p>
...
<ul>
<li><code>pymilvus</code>: a python package works with the vector database service powered by Milvus or Zilliz Cloud.</li>
<li><code>datasets</code>, <code>transformers</code>: Hugging Face packages manage data and utilize models.</li>
<li><code>torch</code>: a powerful library provides efficient tensor computation and deep learning tools.</li>
</ul>
<pre><code class="language-python">$ pip install --upgrade pymilvus transformers datasets torch
...
<pre><code class="language-python">milvus_client.insert(collection_name=COLLECTION_NAME, data=data_list)
<button class="copy-code-btn"></button></code></pre>
<pre><code>{'insert_count': 11,
...
<h2 id="Ask-questions" class="common-anchor-header">Ask questions
    <button data-href="#Ask-questions" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
