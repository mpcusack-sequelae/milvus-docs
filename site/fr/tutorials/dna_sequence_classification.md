...
<h1 id="DNA-Sequence-Classification" class="common-anchor-header">DNA Sequence Classification
    <button data-href="#DNA-Sequence-Classification" class="anchor-icon">
      <svg
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>
  <span class="img-wrapper">
    <img src="/docs/v2.4.x/assets/dna.png" alt="dna" class="doc-image" id="dna" />
    <span>dna</span>
  </span>
</p>
